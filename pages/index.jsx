...
import heroImage from '../public/img/paint.svg'
        ...
        <div className="mx-auto max-w-7xl p-8">
          <div className="pt-12 pb-48 lg:pt-48">
            <div className="relative mx-auto max-w-xl text-center lg:mx-0 lg:max-w-2xl lg:text-left">
              <span className="absolute top-0 left-1/2 -translate-x-1/2 rounded-full bg-pink-400 py-1 px-4 text-xs font-bold uppercase tracking-widest text-white md:text-base lg:left-0 lg:translate-x-0">
                1-day Workshop
              </span>
              <h1 className="pt-12 text-4xl font-black text-white md:text-5xl lg:max-w-2xl lg:text-7xl xl:text-8xl">
                Tailwind CSS Theming
              </h1>
              <p className="mt-4 text-lg font-semibold uppercase tracking-widest text-pink-200 lg:mt-8">
          ...
          <table className="min-w-full divide-y-2 divide-teal-500">
            ...
            <tbody className="divide-y divide-slate-200">
              {program.map((entry, index) => (
                <tr key={index} className={cx(entry.what === 'break' && 'bg-teal-100/50')}>
                  <td
                    className={cx(
...
function AboutMe() {
  return (
    <div className="mx-auto max-w-7xl p-8 py-16 md:py-24 lg:py-32">
      <div className="group prose prose-lg prose-pink mx-auto max-w-prose xl:prose-xl">
