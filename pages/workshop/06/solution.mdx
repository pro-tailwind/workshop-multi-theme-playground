...
const multiThemePlugin = plugin(function ({ addBase }) {
  addBase({
    ':root': {
      '--primary-50': themes[0].colors[50],
      '--primary-100': themes[0].colors[100],
      '--primary-200': themes[0].colors[200],
      '--primary-300': themes[0].colors[300],
      '--primary-400': themes[0].colors[400],
      '--primary-500': themes[0].colors[500],
      '--primary-600': themes[0].colors[600],
      '--primary-700': themes[0].colors[700],
      '--primary-800': themes[0].colors[800],
      '--primary-900': themes[0].colors[900],
    }
  })
  ...
  themes.forEach((theme) => {
    addBase({
      [`[data-theme="${theme.name}"]`]: {
        '--primary-50': theme.colors[50],
        '--primary-100': theme.colors[100],
        '--primary-200': theme.colors[200],
        '--primary-300': theme.colors[300],
        '--primary-400': theme.colors[400],
        '--primary-500': theme.colors[500],
        '--primary-600': theme.colors[600],
        '--primary-700': theme.colors[700],
        '--primary-800': theme.colors[800],
        '--primary-900': theme.colors[900],
      }
    })
  })
}, {
